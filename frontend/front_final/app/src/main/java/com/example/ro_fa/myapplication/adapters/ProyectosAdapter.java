...
public class ProyectosAdapter extends RecyclerView.Adapter<ProyectosAdapter.ViewHolder> {
    ...
    private List<Proyectos> mDataset;
    ...
    public ProyectosAdapter(List<Proyectos> myDataset, Activity mContext) {
    ...
    @Override
    public ProyectosAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lista_proyectos, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final Proyectos proyecto = mDataset.get(position);
        String nombre_completo = proyecto.getCodproyecto() + " " + proyecto.getNombre() + " " + proyecto.getAnho();
